...
For our analysis, we will use 3 different datasets all coming from
...
install.packages(c("conflicted", "here", "vroom", "dplyr", "ggplot2", "tidyr", "stringr", 
                   "tidyverse", "plm", "AER", "sandwich", "sf", "rnaturalearth", 
                   "rnaturalearthdata", "lmtest", "broom", "leaflet", "car", "viridis","png"))
```
